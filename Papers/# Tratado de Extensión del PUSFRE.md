# Tratado de Extensión del PUSFRE v3.5 — Edición Completa con Anexo Masivo Integrado
...
1. **M6 supera a MLP por 35% en RMSE** con 350× menos parámetros.
2. **M6 supera a Translog por 20% en RMSE** y $\Delta$BIC > 10.
3. **Con 10 folds, la ventaja de M6 sobre todos los baselines es estadísticamente robusta** (Wilcoxon p < 0.05).
4. **M2 (Hill sin CES) no supera a M0** ($\Delta$BIC = −8.2). La mejora requiere ambos mecanismos.
5. **GSE no supera a M6** por más de 10 en $\Delta$BIC.
...
**El pipeline CES-Saturado supera a MLP, Translog y GSE en regímenes con estructura clara.**
...
8. **Análisis de sensibilidad al rango de Ω.**
...
**Versión:** 2.0 — Edición con Rigor Categórico y Validación Empírica
**Fecha:** Septiembre 2026
**Licencia:** CC BY-NC-SA 4.0 + Cláusula Comercial Ronin
...
1. De qué resultado de Categoría A se deriva (si aplica).
2. Qué supuestos adicionales requiere.
3. Qué evidencia empírica la sostiene (si existe).
